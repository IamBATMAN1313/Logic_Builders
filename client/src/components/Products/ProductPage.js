...
export default function ProductPage() {
  ...
  // Function to go back to build
  const handleBackToBuild = () => {
    if (buildId && categoryId) {
      navigate(`/category/${categoryId}?returnTo=build&buildId=${buildId}`);
    } else if (buildId) {
  ...
  return (
    <div className="product-page">
      <div className="product-container">
        ...
        {/* Back to Build button when coming from build context */}
        {returnTo === 'build' && buildId && (
          <div className="back-to-build-container">
            <button 
